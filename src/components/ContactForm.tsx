    ...
    <section id="contact" className="py-20 px-4 bg-black bg-opacity-70">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative bg-black bg-opacity-90 p-6 md:p-10 rounded-lg border border-gray-800 shadow-xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={handleChange}
                  className="w-full border-gray-700 bg-gray-900 text-white h-32"
                />
              </div>
              
              <Button
                type="submit"
                className="gradient-btn w-full text-lg py-6"
